...
# html_title = "read-GRACE-geocenter"
html_short_title = "read-GRACE-geocenter"
...
repository_url = f"https://github.com/tsutterley/read-GRACE-geocenter"
html_context = {
    "menu_links": [
        (
